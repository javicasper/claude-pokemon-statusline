...
3. **Ancho** del sprite (default 18)

### Modo no interactivo

```bash
bash install.sh --position=left --selection=rotate --width=18 --yes
bash install.sh --position=right --selection=fixed --pokemon=25 --width=20 --yes
```
